...
#define LocalizableHelperGetStringWithKeyFromTable(key,tb) [[LanguageLocalizableHelper shareInstance] getStringWithKey:key table:tb]
...
@interface LanguageLocalizableHelper : NSObject
